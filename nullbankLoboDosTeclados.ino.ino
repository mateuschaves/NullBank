...
char server[] = "192.168.49.102";    // name address for Google (using DNS)
...
String dataUser = "id=5d00801dd35bb10a9c757787&password=";
...
void setup(){
  ...
  if (client.connect(server, 3000)) {
    ...
    client.println("Host: 192.168.49.102");
    client.println("Content-Type: application/x-www-form-urlencoded");
    client.println("Connection:close");
    client.print("Content-Length:");
    client.println(dataUser.length());
    client.println();
    client.print(dataUser);
...
void clearManPassword(){
  password = "";
  dataUser = "id=5d00801dd35bb10a9c757787&password=";
}
